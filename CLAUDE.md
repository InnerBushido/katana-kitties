...
node tools/world-check.mjs    # 1272 checks: world, dragons, clans, sprites, tournament, consent, balance
...
- **When you fix something, add the check that would have caught it.** That is
  why `world-check` is 1272 assertions and why almost none of them are about
