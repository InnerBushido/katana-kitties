...
npm run docs                  # tools/doc-sync.mjs — regenerate this file's generated tables
```
...
the check that would have caught it.** That is why `world-check` is 1888
assertions.
...
| [docs.md](docs/notes/docs.md) | **this file's own rules** — when a change earns a line here, and how §5 and §6 generate themselves |
